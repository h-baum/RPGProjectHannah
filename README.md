...
Your move can always be typing an item in the room, typing an item in your inventory, or typing an exit.
Drinks go straight to your inventory when selected from the room and can be drunk (selected) at any later time in the game.
The only exception to that is the stale water, which will be drunk immediately and serves the purpose of letting you start not being a little bit thirsty. It's not necessary to win, but it also shows you how drinking water changes your thirst level.
...
If you go to the car without keys, you can not go from your car to any of the shops. Your only exit will be the garage.
If you are walking from room to room, it takes 10 minutes and hydration goes down by 1.
Driving from room to room takes 20 minutes, and hydration goes down by 2.
Mowing from room to room takes 30 minutes, and hydration goes down by 3.
You start the game with hydration of 9. Drinking anything increases hydration by 15, except for stale water which only increases hydration by 5.
